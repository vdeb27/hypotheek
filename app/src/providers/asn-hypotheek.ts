...
const asnHypotheekRentes: Record<number, number[]> = {
  ...
  6:  [3.53, 3.53, 3.63, 3.63, 3.65, 3.65, 3.70, 3.72, 4.12],
  ...
  20: [4.34, 4.34, 4.41, 4.41, 4.49, 4.49, 4.50, 4.62, 5.02]
};

// ASN Duurzaam Wonen (energielabel A+): lagere rentes
const asnDuurzaamRentes: Record<number, number[]> = {
  1:  [2.58, 2.58, 2.77, 2.77, 2.84, 2.84, 2.87, 2.90, 3.30],
  ...
  5:  [2.84, 2.84, 2.92, 2.92, 2.94, 2.94, 3.00, 3.01, 3.41],
  6:  [2.88, 2.88, 2.98, 2.98, 3.00, 3.00, 3.05, 3.07, 3.47],
  7:  [2.93, 2.93, 3.05, 3.05, 3.07, 3.07, 3.12, 3.15, 3.55],
  10: [3.08, 3.08, 3.26, 3.26, 3.26, 3.26, 3.30, 3.36, 3.76],
  12: [3.08, 3.08, 3.26, 3.26, 3.26, 3.26, 3.30, 3.36, 3.76],
  15: [3.31, 3.31, 3.38, 3.38, 3.44, 3.44, 3.55, 3.65, 4.05],
  20: [3.70, 3.70, 3.77, 3.77, 3.85, 3.85, 3.86, 3.98, 4.38]
};
...
export const asnHypotheek: MortgageProvider = {
  ...
  berekenRente({ ltv, heeftNHG, energielabel, rentevastePeriode }) {
    ...
    const ltvIndex = heeftNHG && ltv <= 90 ? 0 : heeftNHG ? 1 :
                     ltv <= 50 ? 2 : ltv <= 60 ? 3 : ltv <= 70 ? 4 :
                     ltv <= 80 ? 5 : ltv <= 90 ? 6 : ltv <= 100 ? 7 : 8;
